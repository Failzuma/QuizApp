...
export default function Dashboard() {
  ...
  const handleGuestAccess = () => {
    // Logic for guest access remains the same, they can see the list.
    // The game page will handle logic for non-logged-in users (e.g., not saving progress)
    ...
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-grow container mx-auto px-4 py-8">
        ...
        <p className="text-muted-foreground mb-8">
          {user ? `Welcome, ${user.username}! Choose a quiz to start.` : 'Choose a quiz to start your learning adventure as a guest.'}
        </p>
